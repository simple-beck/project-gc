...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'snap', get_stylesheet_directory_uri() . '/library/js/libs/snap.min.js', array( 'jquery' ), '', true );
    wp_register_script( 'fancybox', get_stylesheet_directory_uri() . '/library/js/libs/jquery.fancybox.pack.js', array( 'jquery' ), '', true );
    wp_register_script( 'lightslider', get_stylesheet_directory_uri() . '/library/js/libs/lightslider.min.js', array( 'jquery' ), '', true );
